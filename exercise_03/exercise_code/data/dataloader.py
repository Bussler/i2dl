...
class DataLoader:
    ...
    def __iter__(self):
        ...
        def combine_batch_dicts(batch): # combine list of dicts (batch, since dataset is collection of dicts) to a dict of arrays/ dicts
            batch_dict = {}
        ...
        def batch_to_numpy(batch): # converts list to numpy array
            numpy_batch = {}
