...
class Autoencoder(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        reconstruction = self.decoder.forward(self.encoder.forward(x))  
...
class Classifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        ########################################################################
        if(self.hparams["optimizer"] == "SGD"):
            optim = optim.SGD(self.model.parameters(), lr=self.hparams["learning_rate"], momentum=self.hparams["momentum"])
        elif(self.hparams["optimizer"] == "Adam"):
